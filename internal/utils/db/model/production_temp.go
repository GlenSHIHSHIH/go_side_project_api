...
const (
	...
	INSERT_PRODUCTION = `insert into productions(product_id,name,description,options,categories,image,images,url,price,price_min,create_time,update_time,create_user_id)
							select
...
type ProductionTemp struct {
	...
	CreateUserId int       `gorm:"comment:新增人員Id;type:datetime; json:"createUserId"`                                //新增人員
	UpdateUserId int       `gorm:"comment:修改人員Id;type:datetime; json:"updateUserId"`                                //修改人員
}
